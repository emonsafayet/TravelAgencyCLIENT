...
export class Common{
    ...
    // public static setReferenceModule(ModuleName: string = '', RefCode: string) {

    //     console.log(ModuleName, RefCode);
	// 	if (Library.isNullOrEmpty(ModuleName)) this.Notification.ModuleName = Common.getModuleNameFromCode(RefCode);
    //     else this.Notification.ModuleName = ModuleName;
        
    //     console.log("get module name: ", this.Notification.ModuleName);
    //     this.Notification.RefCode = RefCode;
	// }
    // public static setReferenceModule(ModuleName: string = '', RefCode: string, ModuleData:string='0') {
    ...
    //     console.log("get module name: ", this.Notification.ModuleName);
    //     this.Notification.RefCode = RefCode; 
    //     this.Notification.ModuleData=ModuleData;
	// }
