...
export class Config{
   ...
   // LIVE SERVER
    //public static get API_URL(): string {return "https://www.lplmis.com/ERPAPI/api/"}; public static get getBaseUrl(): string {return "https://www.lplmis.com/ERPAPI/"};

  
   // LOCAL SERVER
   public static get API_URL(): string {return "http://localhost:62600/api/"; }  public static get getBaseUrl(): string {return "http://localhost:62600/"; }
